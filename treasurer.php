...
$sql="select name,regdno,image from details r join nominations n where r.Regd=n.regdno AND n.Treasurer>0";
...
if ($result->num_rows > 0) {
	...
	echo  '<div class="col-xs-4">
			<button class="btn"  name="li" value="',$row['regdno'],'">			
				<img src="images/',$row['image'],'" class="img-rounded" alt="Treasurer" width="175" height="175"> 
			</button>		
		</div>';
	if($count%3==2)
	echo '</div></br>';
	...
	echo  '<div class="row" align="center"><div class="col-xs-4">
			<button class="btn"  name="li" value="none">			
				<img src="nota-india.jpg" class="img-rounded" alt="Treasurer" width="175" height="175"> 
			</button>		
		</div></div>';
if(($count-1)%3!=2)
	echo '</div>';
...
if(isset($_POST['li'])){
	...
	echo $value;
	if($value!="none"){
		$insert="UPDATE nominations SET Treasurer=Treasurer+1 where regdno='$value'";
